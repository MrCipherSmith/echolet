# Module packages/client-core/src/sessions
...
`packages/client-core/src/sessions` groups 2 file(s). Exposes 7 public symbol(s).
...
- `packages/client-core/src/sessions/sessionAdapter.ts` - imported by 2, imports 0
- `packages/client-core/src/sessions/sessions.ts` - imported by 0, imports 1

### Depended on by

- `packages/client-core/src/messages` - 1 import(s)
